...
import com.nia.compose.bridge.database.model.asEntity
import com.nia.compose.bridge.database.model.asExternalModel
import com.nia.compose.bridge.model.DemoItem
import com.nia.compose.bridge.network.DemoApi
import com.nia.compose.bridge.network.model.asExternalModel
 ...
 * 真实业务场景中可以：
 * 1. 增加网络失败时的重试；
 * 2. 使用 [com.nia.compose.bridge.common.result.Result] 暴露加载/错误状态；
